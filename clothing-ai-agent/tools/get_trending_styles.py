...
def get_trending_styles_tool(season: str, region: str | None = None) -> dict:
    ...
    trends = {
        "summer": {"colors": ["white", "beige", "pastel"], "styles": ["linen", "cotton", "floral"]},
        "monsoon": {"colors": ["navy", "olive", "black"], "styles": ["waterproof", "layered"]},
        "winter": {"colors": ["burgundy", "black", "grey"], "styles": ["wool", "knits", "jackets"]},
    }
    trend = trends.get(season.lower(), {"colors": ["black", "white"], "styles": ["casual"]})
